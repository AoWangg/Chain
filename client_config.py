...
class client_config:
    ...
    channel_ca = "/home/aowang/anchan/python-sdk/bin/ca.crt"  # 采用channel协议时，需要设置链证书,如采用rpc协议通信，这里可以留空
    channel_node_cert = "/home/aowang/anchan/python-sdk/bin/sdk.crt"  # 采用channel协议时，需要设置sdk证书,如采用rpc协议通信，这里可以留空
    channel_node_key = "/home/aowang/anchan/python-sdk/bin/sdk.key"   # 采用channel协议时，需要设置sdk私钥,如采用rpc协议通信，这里可以留空
    channel_en_crt = "/home/aowang/anchan/python-sdk/bin/gmensdk.crt"  # 仅国密双证书使用，加密证书
    channel_en_key = "/home/aowang/anchan/python-sdk/bin/gmensdk.key"  # 仅国密双证书使用，加密key
    ...
    solc_path = "/home/aowang/anchan/python-sdk/bin/solc/v0.4.25/solc"
